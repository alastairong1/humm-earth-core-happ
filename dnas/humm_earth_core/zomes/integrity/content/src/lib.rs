    ...
    match op.flattened::<EntryTypes, LinkTypes>()? {
        ...
        FlatOp::RegisterCreateLink {
            ...
            match link_type {
                ...
                LinkTypes::AllEncryptedContentByAuthor => {
                    validate_create_link_all_encrypted_content_by_author(
                        action,
                        base_address,
                        target_address,
                        tag,
        ...
        FlatOp::RegisterDeleteLink {
            ...
            match link_type {
                ...
                LinkTypes::AllEncryptedContentByAuthor => {
                    validate_delete_link_all_encrypted_content_by_author(
                        action,
                        original_action,
                        base_address,
                        target_address,
                    ...
                    match app_entry {
                        EntryTypes::EncryptedContent(encrypted_content) => {
                            ...
                            if let ValidateCallbackResult::Valid = result {
                                let original_encrypted_content: Option<EncryptedContent> = original_record
                                    .entry()
                                    .to_app_option()
